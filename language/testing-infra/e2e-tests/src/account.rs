...
impl Account {
    ...
    /// entity.
    pub fn with_keypair(privkey: Ed25519PrivateKey, pubkey: Ed25519PublicKey, addr: Option<AccountAddress>) -> Self {
        let addr = addr.unwrap_or_else(|| libra_types::account_address::from_public_key(&pubkey));
        Account {
            addr,
            privkey,
            pubkey,
